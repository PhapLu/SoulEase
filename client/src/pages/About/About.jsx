...
const OMV = [
    {
        icon: (
            <svg xmlns='http://www.w3.org/2000/svg' height='32px' viewBox='0 -960 960 960' width='32px' fill='#0C896B'>
...
export default function About({ interest = ['Clinicians', 'Therapists', 'Psychiatrists'] }) {
    // Typing effect
        ...
        <div className='about-page'>
            ...
            <section className='about-hero ' data-aos='fade-up'>
                <div className='about-hero-inner'>
                    ...
                    <p className='about-hero-description'>SoulEase focuses on mental-health needs by improving communication and capturing daily-life insights. Our integrated tools help your business thrive while caring for others.</p>

                    <Link to='/auth/signup' className='about-btn-primary'>
                        Discover more
                    </Link>
                </div>
            </section>
            ...
            <section className='about-section' data-aos='fade-up' data-aos-delay='150'>
                <h2 className='about-section-title'>Objective - Mission - Value</h2>
                <p className='about-section-subtitle'>By organizing clients into meaningful groups for easier dashboard and system management, SoulEase enables you to use your time more efficiently and significantly boost your overall productivity.</p>
            ...
            {/* OUR TEAM ---------------------------------------------- */}
            <section className='about-section team' data-aos='fade-up' data-aos-delay='250'>
                <h2 className='about-section-title'>Our Team</h2>
                <p className='about-section-subtitle'>Meet the people behind SoulEase — blending psychology, design and technology to create meaningful tools.</p>
