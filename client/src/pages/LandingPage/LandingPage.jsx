        ...
        <div className="landing-page">
            ...
            <section className="landing-hero" data-aos="fade-up">
                <div className="landing-hero__surface">
                    ...
                    <h1 className="landing-hero__title">
                        ...
                        <span className="landing-hero__script">
                            Mental Healthcare
                        </span>
                    </h1>

                    <p className="landing-hero__subtitle">
                        Track patients, manage therapy notes, Sora-AI assistant,
                        strengthen communication - all in one gentle,
            ...
            >
                <div className="landing-section__header">
                    ...
                    <p className="landing-section__subtitle">
                        Discover what makes SoulEase the best choice EHR
                        platform for your workspace.
                    </p>
                </div>
            ...
            >
                <div className="landing-section__header">
                    <h2 className="landing-section__title">
                        Powerful tools{" "}
                        <span className="landing-highlight">support</span> your{" "}
                        <span className="landing-highlight">work</span>
                    </h2>
                </div>
