...
const featureCards = [
    {
        icon: (
            <svg xmlns='http://www.w3.org/2000/svg' height='35px' viewBox='0 -960 960 960' width='35px' fill='#0A8769'>
...
const toolTabs = [
    {
        ...
        blurb: "From grouping clients' types to managing dashboards or systems, SoulEase helps you focus time where it matters most.",
        checklist: ['Clients', 'Dashboard', 'System'],
        icons: [
            <svg xmlns='http://www.w3.org/2000/svg' height='24px' viewBox='0 -960 960 960' width='24px' fill='#0C1317'>
        ...
        cardTitle: 'Workspace',
        cardText: 'Organize every team, client, and workflow within a single, beautifully simple dashboard built for mental health work.',
        cardIcon: (
            <svg xmlns='http://www.w3.org/2000/svg' height='32px' viewBox='0 -960 960 960' width='32px' fill='#0A8769'>
    ...
    },
    {
        ...
        cardText: 'Draft, summarize, and suggest care actions while keeping your tone warm and human.',
        cardIcon: <img src={Soulra} alt='Soulra AI icon' width={32} height={32} style={{ display: 'block' }} />,
    },
    {
        ...
        cardTitle: 'Tracking',
        cardText: 'Monitor progress, share updates, and keep every file safe in one calm space.',
        cardIcon: (
            <svg xmlns='http://www.w3.org/2000/svg' height='32px' viewBox='0 -960 960 960' width='32px' fill='#0A8769'>
        ...
        <div className='landing-page'>
            ...
            <section className='landing-hero' data-aos='fade-up'>
                <div className='landing-hero__surface'>
                    <div className='landing-hero__badge'>
                        ...
                        <span className='landing-hero__badge-text'>Set up new workspaces in just minutes!</span>
                    </div>

                    <h1 className='landing-hero__title'>
                        A Calmer, Smarter EHR for <span className='landing-hero__script'>Mental Healthcare</span>
                    </h1>
            ...
            <section className='landing-section' data-aos='fade-up' data-aos-delay='80'>
                <div className='landing-section__header'>
                    ...
                    <p className='landing-section__subtitle'>Discover what makes SoulEase the best choice EHR platform for your workspace.</p>
                </div>
            ...
            <section className='landing-tools' data-aos='fade-up' data-aos-delay='120'>
                <div className='landing-section__header'>
                    <h2 className='landing-section__title'>
                        Powerful tools <span className='landing-highlight'>support</span> your <span className='landing-highlight'>work</span>
                    </h2>
                </div>

                <div className='landing-tablist' role='tablist' aria-label='Tool highlights'>
                    {toolTabs.map((tab, index) => (
                        <button key={tab.label} className={`landing-tab ${index === activeTab ? 'is-active' : ''}`} type='button' aria-pressed={index === activeTab} onClick={() => setActiveTab(index)}>
                            {tab.label}
                        </button>
                    ))}
                </div>
