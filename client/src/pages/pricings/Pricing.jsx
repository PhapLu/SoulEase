...
export default function Pricing() {
    ...
    return (
        <div className="pricing-page">
            <section className="pricing-hero" data-aos="fade-up">
                <div className="pricing-hero__text">
                    ...
                    <p className="pricing-hero__subtitle">
                        Get started for free during our early bird stage. All
                        core features are included—no credit card required.
                    </p>
                </div>
                    ...
                    {plans.map((plan) => (
                        <article
                            ...
                            className={`pricing-card ${
                                plan.fullWidth ? "is-full" : ""
                            } ${
                                plan.name === "Solo Practice"
                                    ? "pricing-card--center"
                                    : ""
                            }`}
                        >
                            ...
                            <div className="pricing-card__features-title">
                                All our features with:
                            </div>
                            <ul className="pricing-card__list">
                                {plan.features.map((item) => (
                                    <li
                                        key={`${plan.name}-${item.accent}-${item.text}`}
                                    >
                                        <FontAwesomeIcon
                                            icon={item.icon || faDiagramProject}
                                        />
                                        <span>
            ...
            <section
                className="landing-tools pricing-features"
                data-aos="fade-up"
                data-aos-delay="120"
            >
                <div className="landing-section__header">
                    <h2 className="landing-section__title">
                        Our features included in every plan
                    </h2>
                </div>
