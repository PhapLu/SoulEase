...
import PatientModalForm from "./patientModelForm/PatientModelForm";
...
export default function FolderClients() {
    ...
    const filteredClients = useMemo(() => {
        ...
        let data = records.filter((client) =>
    ...
    const handleDeleteEdit = async () => {
        const confirmed = window.confirm(
            "Are you sure you want to delete this folder? All the patient records will go to archived folder."
        );
        if (!confirmed) return;
            ...
            <section className="folder-page">
                ...
                {openCreateModal && (
                    <PatientModalForm
                        ...
                        disabled={folderInfo.isArchived}
                    />
                )}
            </section>
        </>
