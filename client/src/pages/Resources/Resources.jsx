      ...
      <section className="about-hero">
        <div className="about-hero-inner">
          ...
          <p className="about-hero-description">
            It is our pleasure to clear up any confusion and provide you with
            the clarity you need, ensuring that your experience with us remains
            smooth, simple, and fully supported.
          </p>
      ...
      <div className="resources-layout">
        ...
        <aside className="resources-sidebar">
          ...
          <ul className="resources-sidebar-list">
            ...
            <li onClick={() => scrollToSection("subscription")}>
        ...
        <main className="resources-content">
          ...
          <section className="resources-item">
            <h2 className="resources-question">
              How do I sign up for SoulEase?
            </h2>
            <p className="resources-answer">
              Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem
              ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum.
          ...
          <section className="resources-item">
            <h2 className="resources-question">
              Will the work I do during my trial be saved for me when I sign up
          ...
          <section className="resources-item">
            <h2 className="resources-question">
              What happens if I don’t sign up for a paid subscription after my
              free trial?
            </h2>
            <p className="resources-answer">
              Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem
          ...
          <section className="resources-item">
            <h2 className="resources-question">
              How much does SoulEase cost, and are there any additional fees?
            </h2>
            <p className="resources-answer">
              Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem
              ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum.
          ...
          <section className="resources-item">
            <h2 className="resources-question">
              Can I export data from SoulEase?
            </h2>
            <p className="resources-answer">
              Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem
              ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum.
