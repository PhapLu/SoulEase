...
const serviceSections = [
    {
        ...
        blurb: 'By organizing clients into meaningful groups for easier dashboard and system management, SoulEase enables you to use your time more efficiently and significantly boost your overall productivity.',
        cards: [
            {
                title: 'Grouping clients',
                text: 'Keep every profile neatly organized to reduce context switching and confusion.',
                icon: (
                    <svg xmlns='http://www.w3.org/2000/svg' height='24px' viewBox='0 -960 960 960' width='24px' fill='#0A8769'>
    ...
    },
    {
        ...
        blurb: 'SoulEase keeps every interaction thoughtful. Summaries, suggestions, and chatbot support help you respond faster and stay empathetic.',
        cards: [
            {
    ...
    },
    {
        ...
        blurb: 'Stay on top of client well-being with real-time messaging, visualized progress, and secure storage.',
        cards: [
            {
    ...
    return (
        <div className='services-page'>
            <section className='services-hero' data-aos='fade-up'>
                <div className='services-hero__grid'>
                    <div className='services-hero__content'>
                        ...
                        <p className='services-hero__subtitle'>Enhance the quality of your work with a modern, intelligent toolkit designed to optimize your time, boost productivity, and help you deliver results with greater efficiency and confidence.</p>
                    </div>

                    <div className='services-hero__panel'>
                        <div className='services-hero__cards'>
                            <article className='services-hero__card is-active'>
                                <div className='services-hero__icon'>{activeCard.icon}</div>
                        ...
                        <div className='services-hero__dots' aria-label='Hero highlights'>
                            {heroSlides.map((_, index) => (
                                <button type='button' key={index} className={activeHero === index ? 'is-active' : ''} onClick={() => setActiveHero(index)} aria-pressed={activeHero === index} />
                            ))}
                        </div>
                    </div>
                </div>
            ...
            {serviceSections.map((section) => (
                <section key={section.id} className='services-section' data-aos='fade-up' data-aos-offset='80'>
                    <div className='services-section__top'>
                        ...
                        <div className='services-section__visual' aria-hidden='true'></div>
                    </div>
                        ...
                        {section.cards.map((card) => (
                            <article key={card.title} className='services-card'>
                                <div className='services-card__header'>
                                    <div className='services-card__icon'>{card.icon}</div>
                                    <h3>{card.title}</h3>
                                </div>
