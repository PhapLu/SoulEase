    ...
    return (
        <header className='se-header'>
            <div className='se-header__inner'>
                ...
                {/* MENU DESKTOP + MOBILE */}
                <nav className={`se-nav ${isMobileOpen ? 'se-nav--open' : ''}`} aria-hidden={!isMobileOpen}>
                ...
                {/* Hamburger mobile */}
                <button className={`se-menu-toggle ${isMobileOpen ? 'se-menu-toggle--open' : ''}`} onClick={toggleMobile} aria-label='Toggle navigation'>
                    <span />
                    <span />
                    <span />
                </button>
