...
export const RESERVED_PATHS = new Set([
    "", "posts", "archive", "not-found", "order-management", "my-commission-requests",
    "talent-hub", "badges", "orders", "characters", "commission-hub", "oc-universe",
    "galaxies", "newss", "search", "threads", "paypal", "dashboard",
    "auth", "statics", "error", "forbidden",
